...
def printLogo():
    print('\x1b[37;4mhttps://github.com/WazniAhamed\x1b[0m')
    print('\x1b[37;36m')
    print('                     Bluetooth DOS Attack Script                            ')
    print('+-------------------------------------------------------------------------+ ')
    print('|  _ __ ___   __ _  __| | ___   | |__  _   _                              | ')
    print("| | '_ ` _ \ / _` |/ _` |/ _ \  | '_ \| | | |   WAZNI AHAMED ( SRILANKAN) | ")
    print('| | | | | | | (_| | (_| |  __/  | |_) | |_| |   COPYRIGHT OF WAZNI        | ')
    print('| |_| |_| |_|\__,_|\__,_|\___|  |_.__/ \__, |      2021.10.27             | ')
    print('|                                      |___/  TEST THIS TOOL IN INDOOR    | ')
    print('+-------------------------------------------------------------------------+ ')
    print('\x1b[0m')
